...
if (isset($_GET["id"])) {
    ...
    $sql = "SELECT `title`, `more_info`, `price`, `sqm`, `type`, `approved`, `status`, `seller_id`, `latitude`, `longitude`, `location`, `bedroom`, `garages`, `cr`, seller_property.image, `date`, sl.name as Name,floor_sqm FROM `seller_property`

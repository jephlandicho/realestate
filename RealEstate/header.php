  ...
  <link rel="stylesheet" id='bootstrap-min-css' href="bootstrap-5/css/bootstrap.min.css" type='text/css' media='all'>
          ...
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                      data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Log In/ Sign Up </a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === 'registerSeller') {
                            alert('New Seller Account Created');
